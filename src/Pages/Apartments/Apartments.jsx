    ...
    <div  className="my-20 lg:my-32 max-w-screen-xl mx-auto">
      <div className="flex flex-col items-center">
        ...
        <p className="lg:w-1/2 text-center">
          We offer more comfortable and privileges in our deals.Here you can get premium, luxurious as well as affordable package with your comfort. Grab your choice as fast and enjoy your time. 
        </p>
